...
const bestCourses: Course[] = [
  {
    id: 1, subject: 'TOPIK', subjectColor: '#C0392B',
    title: '[TOPIK II] 김민지의 문법 완전정복 - 고득점 전략',
    instructor: '김민지', topikLevel: 'TOPIK II', levelNum: '4~6급', price: 59000, originalPrice: 89000, discount: 33,
    rating: 4.9, reviewCount: 28541, studentCount: '18K',
    tags: ['문법', 'TOPIK II', '고득점'], isBest: true,
  },
  {
    id: 2, subject: '말하기', subjectColor: '#2980B9',
    title: '이준호의 한국어 회화 집중 훈련 - 실전 말하기 완성',
    instructor: '이준호', topikLevel: 'TOPIK I·II', levelNum: '2~4급', price: 49000, originalPrice: 79000, discount: 38,
    rating: 4.8, reviewCount: 19283, studentCount: '14K',
    tags: ['회화', '말하기', '실전'], isBest: true,
  },
  {
    id: 3, subject: '쓰기', subjectColor: '#8E44AD',
    title: '박소연의 TOPIK 작문 고득점 - 서술형 완벽 대비',
    instructor: '박소연', topikLevel: 'TOPIK II', levelNum: '5~6급', price: 45000, originalPrice: 69000, discount: 34,
    rating: 4.9, reviewCount: 14920, studentCount: '11K',
    tags: ['쓰기', '작문', 'TOPIK II'], isNew: true,
  },
  {
    id: 4, subject: '비즈니스', subjectColor: '#E67E22',
    title: '한태우의 직장 한국어 실전 - 비즈니스 커뮤니케이션',
    instructor: '한태우', topikLevel: 'TOPIK II', levelNum: '4~6급', price: 55000, originalPrice: 85000, discount: 35,
    rating: 4.7, reviewCount: 8763, studentCount: '9K',
    tags: ['비즈니스', '직장한국어', '실전'],
  },
  {
    id: 5, subject: '문화', subjectColor: '#16A085',
    title: '최유나의 K-문화로 배우는 한국어 - 드라마·K-POP 활용',
    instructor: '최유나', topikLevel: 'TOPIK I·II', levelNum: '전급', price: 0, originalPrice: 49000, discount: 100,
    rating: 4.9, reviewCount: 35221, studentCount: '22K',
    tags: ['문화', 'K-POP', '드라마'], isFree: true, isBest: true,
  },
  {
    id: 6, subject: '입문', subjectColor: '#27AE60',
    title: '신동호의 한글부터 시작하기 - 왕초보 한국어 입문',
    instructor: '신동호', topikLevel: 'TOPIK I', levelNum: '1~2급', price: 39000, originalPrice: 59000, discount: 33,
    rating: 4.8, reviewCount: 12004, studentCount: '31K',
    tags: ['입문', '한글', '왕초보'], isNew: true,
  },
]
